...
from models.LSTNet import Transformer, TransformerEncoder, TransformerDecoderLayer, \
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Towards Local Visual Modeling for Image Captioning')
    parser.add_argument('--exp_name', type=str, default='LSTNet')
